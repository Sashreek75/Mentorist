#!/usr/bin/env node
/**
 * Clear all data from Mentorist database tables
 * This clears mentorist_profiles, mentorist_questions, and mentorist_alerts
...
async function clearAllData() {
  ...
  try {
    ...
    const { error: questionsErr, data: questionsData } = await supabase
    ...
    // Clear mentorist_profiles last (main table)
    ...
    console.log("   3. Delete all test users manually (can't delete via anon key)");
    console.log("   4. Then test signup/login again with the fixed code");
